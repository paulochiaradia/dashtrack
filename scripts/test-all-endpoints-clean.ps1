...
Write-Host "â•‘       TESTE COMPLETO DE TODOS OS ENDPOINTS               â•‘" -ForegroundColor Magenta
...
if ($loginResponse) {
    ...
    Write-Host "`nâŒ CRITICAL: Cannot continue without authentication!" -ForegroundColor Red
    exit 1
}
